...
triángulo rectángulo y luego calcule e imprima el área y el perímetro
del triángulo.

El programa debe:

Solicitar al usuario que ingrese la longitud de los dos lados del triángulo
rectángulo.
...
func main() {
	...
	// Calculamos la hipotenusa con el teorema de Pitagoras
	// Raiz cuadrada de lado1 al cuadrado + lado2 al cuadrado
	var hipotenusa float64 = math.Sqrt(
		math.Pow(float64(lado1), 2) + math.Pow(float64(lado2), 2),
	)
